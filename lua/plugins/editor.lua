return {
  { "MunifTanjim/nui.nvim", lazy = true },
  {
    ...
    keys = {
      { "<leader>er", ":Neotree reveal float<CR>", desc = "Reveal Float File Explorer" },
    ...
    opts = {
      ...
      filesystem = {
        ...
        filtered_items = { hide_dotfiles = false, hide_gitignored = false, never_show = { ".DS_Store", "thumbs.db" } },
      },
      event_handlers = {
        {
