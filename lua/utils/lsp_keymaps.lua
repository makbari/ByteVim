...
function M.setup_keymaps()
    ...
    local keymaps = {
        -- Use fzf-lua for LSP actions with UI
        ...
        -- Native vim.lsp for hover, signature, rename, diagnostics
        ...
        -- Search notes
        {
            mode = "n",
            keys = "<leader>fn",
            func = ByteVim.notes.search_floating_notes,
            desc = "Find Notes (fzf-lua)",
        },
        {
            mode = "n",
            keys = "<leader>nn",
            func = ByteVim.notes.floating_note,
            desc = "New Floating Note",
        },
        {
            mode = "n",
            keys = "<leader>dn",
            func = ByteVim.notes.delete_note,
            desc = "Delete Note",
        },
    }

    -- Loop through and set keymaps using your utility
